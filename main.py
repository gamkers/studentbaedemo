...
def main():
    ...
    if st.session_state.react_agent_executor is None:
        ...
        react_agent = create_react_agent(llm, tools=tools, prompt=prompt_react + "*IMPORTANT NOTE* Add you answers without using tools also and provide a video and a pdf")
